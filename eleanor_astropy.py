...
def get_lc(ra,dec):
    ...
    # do_pca=False because sector 13 returns a singular matrix with do_pca=True
    ...
    with open("0500tess.txt",'w') as ofile:
...
def get_plot(mjd,flux,ferr,phase,freq_grid,power,peak_freq,mphase,model):
    ...
    plt.suptitle("J0642$-$5605")
    plt.savefig("0642m5605_tess.pdf",dpi=500)
...
if __name__ == '__main__':
    ...
    ra = float(RA2Decimal("06:42:07.99"))
    dec = float(Dec2Decimal("-56:05:47.44"))
    print(ra,dec)
    ...
    if bootstrap:
        ...
        np.savetxt('0642res.txt',result) # Save the output in a 2-column file: [freq, amplitude]
